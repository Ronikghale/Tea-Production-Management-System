...
<body>
    ...
    <div class="profile-container">
        ...
        <div class="profile-actions">
            <a class="btn" href="${pageContext.request.contextPath}/EditProfile">Edit Profile</a>
            <a class="btn" href="${pageContext.request.contextPath}/ChangePassword">Change Password</a>
        </div>
    </div>
</body>
</html>
