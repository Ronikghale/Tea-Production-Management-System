    ...
    <div class="header-container">
        ...
        <nav class="main-nav">
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}/admindashboard"><i class="fas fa-cogs"></i> Admin Dashboard</a></li>
            </ul>
        </nav>
        ...
        <div class="nav-icons">
            ...
            <!-- Logout button -->
          <a href="${pageContext.request.contextPath}/login" class="nav-icon logout-btn">
