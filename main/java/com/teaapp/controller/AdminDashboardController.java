...
public class AdminDashboardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Fetch data
        int totalProducts = dashboardService.getTotalProducts1();
        int totalCustomers = dashboardService.getTotalCustomers1();
        int pendingOrders = dashboardService.getPendingOrders();
        int lowInventory = dashboardService.getLowInventory();
